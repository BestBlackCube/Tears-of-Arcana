        ...
        if (Range == 1)
        {
            if (this.gameObject == ObjectSet.Field_inMonster[0] && ObjectSet.Enemy_Name[0] == "OrangeGolem")
            {
                if (hpbar == null)
                {
                    ...
                    Vector3 HpBarPos = new Vector3(transform.position.x, transform.position.y - 6f, 0);
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[1] && ObjectSet.Enemy_Name[1] == "OrangeGolem")
            {
                ...
                {
                    hpbar = Instantiate(HpBar_prefab, canvas.transform).GetComponent<RectTransform>();
                    Vector3 HpBarPos = new Vector3(transform.position.x, transform.position.y - 7.5f, 0);
                    hpbar.position = HpBarPos;
