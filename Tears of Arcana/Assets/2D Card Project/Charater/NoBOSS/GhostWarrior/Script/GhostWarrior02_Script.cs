        ...
        if (Range == 2)
        {
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[0] && ObjectSet.TargetGuide[0] == null && ObjectSet.Enemy_Name[0] == "GhostWarrior02")
            {
                ...
                switch (deckField.Click_Card.Card_name)
                {
                    ...
                    case "전격":
                    case "고드름":
                        guide.offset[0] = new Vector3(-1.1f, 2.2f, 0);
                        guide.offset[1] = new Vector3(1.1f, 2.2f, 0);
                        guide.offset[2] = new Vector3(-1.1f, -2.3f, 0);
                        guide.offset[3] = new Vector3(1.1f, -2.3f, 0);
                        break;
