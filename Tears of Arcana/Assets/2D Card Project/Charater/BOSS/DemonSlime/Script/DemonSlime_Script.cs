...
public class DemonSlime_Script : MonoBehaviour
{
    ...
    void animationPosition(int Range)
    {
        if (Range == 1)
        {
            if (this.gameObject == ObjectSet.Field_inMonster[0] && ObjectSet.Enemy_Name[0] == "DemonSlime")
            {
                if (hpbar == null)
                {
                    ...
                    Vector3 HpBarPos = new Vector3(transform.position.x, transform.position.y - 11f, 0);
                    hpbar.position = HpBarPos;
                    animation_position = ObjectSet.Field_transform[0];
                }
            }
            if (this.gameObject == ObjectSet.Field_inMonster[1] && ObjectSet.Enemy_Name[1] == "DemonSlime")
            {
                if (hpbar == null)
                {
                    hpbar = Instantiate(HpBar_prefab, canvas.transform).GetComponent<RectTransform>();
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[2] && ObjectSet.Enemy_Name[2] == "DemonSlime")
            {
                if (hpbar == null)
                {
                    hpbar = Instantiate(HpBar_prefab, canvas.transform).GetComponent<RectTransform>();
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[3] && ObjectSet.Enemy_Name[3] == "DemonSlime")
            {
                if (hpbar == null)
                {
                    hpbar = Instantiate(HpBar_prefab, canvas.transform).GetComponent<RectTransform>();
        ...
        if (Range == 2)
        {
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[1] && ObjectSet.TargetGuide[1] == null && ObjectSet.Enemy_Name[1] == "DemonSlime")
            {
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[3] && ObjectSet.TargetGuide[3] == null && ObjectSet.Enemy_Name[3] == "DemonSlime")
            {
    ...
    void targetArrow_inField(int Range)
    {
        if (Range == 1)
        {
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[1] && ObjectSet.TargetArrow[1] == null && ObjectSet.Enemy_Name[1] == "DemonSlime")
            {
                Vector3 player_offset = new Vector3(animation_position.x, 6, 0);
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[3] && ObjectSet.TargetArrow[3] == null && ObjectSet.Enemy_Name[3] == "DemonSlime")
            {
                Vector3 player_offset = new Vector3(animation_position.x, 6, 0);
