...
public class DemonSlime_Script : MonoBehaviour
{
    ...
    void OnMouseOver()
    {
        ...
        {
            deckField.Click_Card.Object_name = "DemonSlime";
            Arrow = false;
        }
        if (targetCard && deckField.Click_Card != null)
        {
    ...
    void OnMouseDown()
    {
        if (deckField.Click_Card != null)
            if (cardUse && deckField.Click_Card.Object_name == "DemonSlime")
            {
    ...
    void animationPosition(int Range)
    {
        if (Range == 1)
        {
            if (this.gameObject == ObjectSet.Field_inMonster[0] && ObjectSet.Enemy_Name[0] == "DemonSlime" ||
                this.gameObject == ObjectSet.Field_inMonster[1] && ObjectSet.Enemy_Name[1] == "DemonSlime" ||
                this.gameObject == ObjectSet.Field_inMonster[2] && ObjectSet.Enemy_Name[2] == "DemonSlime" ||
                this.gameObject == ObjectSet.Field_inMonster[3] && ObjectSet.Enemy_Name[3] == "DemonSlime")
            {
                if (ObjectSet.EnemyBossHpbar != null)
                {
                    ...
                    Vector3 HpBarPos = new Vector3(transform.position.x - 7.5f, transform.position.y - 11f, 0);
        ...
        if (Range == 2)
        {
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[0] && ObjectSet.TargetGuide[0] == null && ObjectSet.Enemy_Name[0] == "DemonSlime" ||
                this.gameObject == ObjectSet.Field_inMonster[1] && ObjectSet.TargetGuide[1] == null && ObjectSet.Enemy_Name[1] == "DemonSlime" ||
                this.gameObject == ObjectSet.Field_inMonster[2] && ObjectSet.TargetGuide[2] == null && ObjectSet.Enemy_Name[2] == "DemonSlime" ||
                this.gameObject == ObjectSet.Field_inMonster[3] && ObjectSet.TargetGuide[3] == null && ObjectSet.Enemy_Name[3] == "DemonSlime")
            {
                ...
                switch (deckField.Click_Card.Card_name)
                {
                    ...
                    case "화염장판":
                    case "얼음안개":
                        guide.offset[0] = new Vector3(-4f, 1f, 0);
                        guide.offset[1] = new Vector3(4f, 1f, 0);
                        guide.offset[2] = new Vector3(-4f, -9f, 0);
                        guide.offset[3] = new Vector3(4f, -9f, 0);
                        break;
        ...
        if (Range == 3)
        {
            if (this.gameObject == ObjectSet.Field_inMonster[2] && ObjectSet.TargetGuide[2] != null && ObjectSet.Enemy_Name[2] == "DemonSlime")
            {
    ...
    void targetArrow_inField(int Range)
    {
        if (Range == 1)
        {
            if (this.gameObject == ObjectSet.Field_inMonster[0] && ObjectSet.TargetArrow[0] == null && ObjectSet.Enemy_Name[0] == "DemonSlime" ||
                this.gameObject == ObjectSet.Field_inMonster[1] && ObjectSet.TargetArrow[1] == null && ObjectSet.Enemy_Name[1] == "DemonSlime" ||
                this.gameObject == ObjectSet.Field_inMonster[2] && ObjectSet.TargetArrow[2] == null && ObjectSet.Enemy_Name[2] == "DemonSlime" ||
                this.gameObject == ObjectSet.Field_inMonster[3] && ObjectSet.TargetArrow[3] == null && ObjectSet.Enemy_Name[3] == "DemonSlime")
            {
        ...
        if (Range == 2)
        {
            if (this.gameObject == ObjectSet.Field_inMonster[2] && ObjectSet.TargetArrow[2] != null && ObjectSet.Enemy_Name[2] == "DemonSlime")
            {
    ...
    void Attack_Order()
    {
        if (stun_count != 0)
        {
            if (this.gameObject == ObjectSet.Field_inMonster[0] && ObjectSet.Enemy_Name[0] == "DemonSlime" && attack_order.Order_1)
            {
                stun_countDown = true;
                if (stun_countDown)
                {
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[1] && ObjectSet.Enemy_Name[1] == "DemonSlime" && attack_order.Order_2)
            {
                stun_countDown = true;
                if (stun_countDown)
                {
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[2] && ObjectSet.Enemy_Name[2] == "DemonSlime" && attack_order.Order_3)
            {
                stun_countDown = true;
                if (stun_countDown)
                {
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[3] && ObjectSet.Enemy_Name[3] == "DemonSlime" && attack_order.Order_4)
            {
                stun_countDown = true;
                if (stun_countDown)
                {
    ...
    void Enemy_NameLess()
    {
        if (this.gameObject == ObjectSet.Field_inMonster[0] && ObjectSet.Enemy_Name[0] == "DemonSlime") ObjectSet.Enemy_Name[0] = null;
        if (this.gameObject == ObjectSet.Field_inMonster[1] && ObjectSet.Enemy_Name[1] == "DemonSlime") ObjectSet.Enemy_Name[1] = null;
        if (this.gameObject == ObjectSet.Field_inMonster[2] && ObjectSet.Enemy_Name[2] == "DemonSlime") ObjectSet.Enemy_Name[2] = null;
        if (this.gameObject == ObjectSet.Field_inMonster[3] && ObjectSet.Enemy_Name[3] == "DemonSlime") ObjectSet.Enemy_Name[3] = null;
    }
