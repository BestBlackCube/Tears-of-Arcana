...
public class Titan_Script : MonoBehaviour
{
    ...
    void OnMouseOver()
    {
        ...
        {
            deckField.Click_Card.Object_name = "Titan";
            Arrow = false;
        }
        if (targetCard && deckField.Click_Card != null)
        {
    ...
    void OnMouseDown()
    {
        if (deckField.Click_Card != null)
            if (cardUse && deckField.Click_Card.Object_name == "Titan")
            {
    ...
    void Attack_Order()
    {
        if (stun_count != 0)
        {
            if (this.gameObject == ObjectSet.Field_inMonster[0] && ObjectSet.Enemy_Name[0] == "Titan" && attack_order.Order_1)
            {
                stun_countDown = true;
                if (stun_countDown)
                {
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[1] && ObjectSet.Enemy_Name[1] == "Titan" && attack_order.Order_2)
            {
                stun_countDown = true;
                if (stun_countDown)
                {
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[2] && ObjectSet.Enemy_Name[2] == "Titan" && attack_order.Order_3)
            {
                stun_countDown = true;
                if (stun_countDown)
                {
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[3] && ObjectSet.Enemy_Name[3] == "Titan" && attack_order.Order_4)
            {
                stun_countDown = true;
                if (stun_countDown)
                {
    ...
    void Enemy_NameLess()
    {
        if (this.gameObject == ObjectSet.Field_inMonster[0] && ObjectSet.Enemy_Name[0] == "Titan") ObjectSet.Enemy_Name[0] = null;
        if (this.gameObject == ObjectSet.Field_inMonster[1] && ObjectSet.Enemy_Name[1] == "Titan") ObjectSet.Enemy_Name[1] = null;
        if (this.gameObject == ObjectSet.Field_inMonster[2] && ObjectSet.Enemy_Name[2] == "Titan") ObjectSet.Enemy_Name[2] = null;
        if (this.gameObject == ObjectSet.Field_inMonster[3] && ObjectSet.Enemy_Name[3] == "Titan") ObjectSet.Enemy_Name[3] = null;
    }
