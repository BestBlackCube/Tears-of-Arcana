...
public class DeathBringer_Script : MonoBehaviour
{
    ...
    void OnMouseOver()
    {
        ...
        {
            deckField.Click_Card.Object_name = "DeathBringer";
            Arrow = false;
        }
        if (targetCard && deckField.Click_Card != null)
        {
    ...
    void OnMouseDown()
    {
        if (deckField.Click_Card != null)
            if (cardUse && deckField.Click_Card.Object_name == "DeathBringer")
            {
    ...
    void Hit_Enemy() // 플레이어에게 공격 받았을때 실행 되는 애니메이션
    {
        ...
        if (nowHp <= 0f)
        {
            ...
            {
                if (this.gameObject.GetComponent<DeathBringer_Script>().stun_count != 0 ||
                    this.gameObject.GetComponent<DeathBringer_Script>().stun_count == 0)
                {
                    if (this.gameObject == ObjectSet.Field_inMonster[0] && ObjectSet.Enemy_Name[0] == "DeathBringer")
                        ObjectSet.EnemyStun[0].gameObject.SetActive(false);
                    if (this.gameObject == ObjectSet.Field_inMonster[1] && ObjectSet.Enemy_Name[1] == "DeathBringer")
                        ObjectSet.EnemyStun[1].gameObject.SetActive(false);
                    if (this.gameObject == ObjectSet.Field_inMonster[2] && ObjectSet.Enemy_Name[2] == "DeathBringer")
                        ObjectSet.EnemyStun[2].gameObject.SetActive(false);
                    if (this.gameObject == ObjectSet.Field_inMonster[3] && ObjectSet.Enemy_Name[3] == "DeathBringer")
    ...
    void animationPosition(int Range)
    {
        ...
        if (Range == 2)
        {
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[0] && ObjectSet.TargetGuide[0] == null && ObjectSet.Enemy_Name[0] == "DeathBringer")
            {
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[1] && ObjectSet.TargetGuide[1] == null && ObjectSet.Enemy_Name[1] == "DeathBringer")
            {
                if (player.Skill_name == "화염장판" || player.Skill_name == "얼음안개") player.Field_name = "FieldAll";
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[2] && ObjectSet.TargetGuide[2] == null && ObjectSet.Enemy_Name[2] == "DeathBringer")
            {
                if (player.Skill_name == "화염장판" || player.Skill_name == "얼음안개") player.Field_name = "FieldAll";
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[3] && ObjectSet.TargetGuide[3] == null && ObjectSet.Enemy_Name[3] == "DeathBringer")
            {
                if (player.Skill_name == "화염장판" || player.Skill_name == "얼음안개") player.Field_name = "FieldAll";
    ...
    void targetArrow_inField(int Range)
    {
        if (Range == 1)
        {
            if (this.gameObject == ObjectSet.Field_inMonster[0] && ObjectSet.TargetArrow[0] == null && ObjectSet.Enemy_Name[0] == "DeathBringer")
            {
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[1] && ObjectSet.TargetArrow[1] == null && ObjectSet.Enemy_Name[1] == "DeathBringer")
            {
                Vector3 player_offset = new Vector3(animation_position.x, 6, 0);
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[2] && ObjectSet.TargetArrow[2] == null && ObjectSet.Enemy_Name[2] == "DeathBringer")
            {
                Vector3 player_offset = new Vector3(animation_position.x, 6, 0);
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[3] && ObjectSet.TargetArrow[3] == null && ObjectSet.Enemy_Name[3] == "DeathBringer")
            {
                Vector3 player_offset = new Vector3(animation_position.x, 6, 0);
    ...
    void Attack_Order()
    {
        if (stun_count != 0)
        {
            if (this.gameObject == ObjectSet.Field_inMonster[0] && ObjectSet.Enemy_Name[0] == "DeathBringer" && attack_order.Order_1)
            {
                stun_countDown = true;
                if (stun_countDown)
                {
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[1] && ObjectSet.Enemy_Name[1] == "DeathBringer" && attack_order.Order_2)
            {
                stun_countDown = true;
                if (stun_countDown)
                {
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[2] && ObjectSet.Enemy_Name[2] == "DeathBringer" && attack_order.Order_3)
            {
                stun_countDown = true;
                if (stun_countDown)
                {
            ...
            if (this.gameObject == ObjectSet.Field_inMonster[3] && ObjectSet.Enemy_Name[3] == "DeathBringer" && attack_order.Order_4)
            {
                stun_countDown = true;
                if (stun_countDown)
                {
    ...
    void Enemy_NameLess()
    {
        if (this.gameObject == ObjectSet.Field_inMonster[0] && ObjectSet.Enemy_Name[0] == "DeathBringer") ObjectSet.Enemy_Name[0] = null;
        if (this.gameObject == ObjectSet.Field_inMonster[1] && ObjectSet.Enemy_Name[1] == "DeathBringer") ObjectSet.Enemy_Name[1] = null;
        if (this.gameObject == ObjectSet.Field_inMonster[2] && ObjectSet.Enemy_Name[2] == "DeathBringer") ObjectSet.Enemy_Name[2] = null;
        if (this.gameObject == ObjectSet.Field_inMonster[3] && ObjectSet.Enemy_Name[3] == "DeathBringer") ObjectSet.Enemy_Name[3] = null;
    }
